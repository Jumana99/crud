  ...
  return (
    ...
    <div className="row flex-nowrap">
      ...
      <div className="col py-3">
        ...
        <Input errors={errors}  id={'username'} title={'user name'} type={"text"} value={user.name} name={'name'}  handelData={handelData}/>
        <Input errors={errors}  id={"email"} title={'user email'} type={"email"}  value={user.email} name={'email'}  handelData={handelData} />
        <Input errors={errors}  id={"password"} title={'user password'} type={"password"}  value={user.passsword} name={'password'}  handelData={handelData}/>
